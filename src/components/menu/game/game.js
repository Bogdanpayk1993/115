    ...
    constructor(props) {
        ...
        function changeSize() {
            ...
            if (width / height > 1280 / 800) {
                ...
                html.setAttribute("style", "background-size: 100%")
            } else {
                html.removeAttribute("style")
                html.setAttribute("style", "background-position-x: center;")
            }
        }
    }
    ...
    render() {
        ...
        return (
            <>
                    ...
                    <div className="container">
                        ...
                        <div className="score">
                            <label className="label">
                                <label>
                                <p> Рахунок: </p>
                                <p> Гравець - {this.scoresUser} </p>
                                <p> Комп'ютер - {this.scoresComputer} </p>
                                </label> 
                            </label>
                        </div>
                        <div className="user">
                ...
                {
                    this.result == true ?
                        <Result store={this.store} result={this.result_f} scoresUser={this.scoresUser1} scoresComputer={this.scoresComputer1} />
                        :
                        null
                }
                {
                    this.scoresUser >= 115 || this.scoresComputer >= 115 ?
                        <Finish_game store={this.store} render_again={this.render_again} result_false={this.result_false} start_game={this.start_game} scoresUser={this.scoresUser} scoresComputer={this.scoresComputer} />
                        :
                        null
                }
            </>
